...
class ViTVAE(nn.Module):
    ...
    def __init__(self, latent_dim=16, vit_name='google/vit-base-patch16-224-in21k'):
        ...
        self.encoder_hidden_size = self.encoder.config.hidden_size  # 768 for ViT-B
    ...
    def unfreeze_last_k_vit_blocks(self, k: int, also_unfreeze_ln_head: bool = True, also_unfreeze_embeddings: bool = False):
        ...
        assert hasattr(self.encoder, "encoder") and hasattr(self.encoder.encoder, "layer")
...
def make_loaders_from_arrays_flexible(
    ...
    def to_tensor_nchw(x):
        ...
        # If uint8 0..255 and user didn’t request normalization, warn-raise
...
if __name__ == "__main__":
    ...
    batch_size=16,
    num_workers=4,
    normalize_from_uint8=False,  # set True if your data is uint8 0..255
)
